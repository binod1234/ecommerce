...
class Front extends CI_Controller {
    ...
    public function index() {
        ...
        $data['total'] = $this->main_model->getLatestProductsCount();
        
        $this->load->view("home", $data);
    }

    public function search() {
        $search=$this->input->post('search-box');
        $data['categories'] = $this->main_model->getAllCategories();
        $data['home_products'] = $this->main_model->getLatestProductsSearch($search);
        $data['total'] = $this->main_model->getLatestProductsCount();
        $data['search']=$search;
        $this->load->view("home", $data);
    }
...
$data['total'] = $this->main_model->getCategoryProductsCount($this->uri->segment(2));
